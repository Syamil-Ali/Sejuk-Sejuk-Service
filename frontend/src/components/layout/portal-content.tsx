...
export function PortalContent({
  ...
  return (
    <div className="min-w-0 lg:h-full lg:overflow-hidden">
      <header className="sticky top-0 z-20 flex min-h-16 items-center justify-between border-b border-line bg-white/90 px-3 backdrop-blur sm:px-4 lg:hidden">
        <div className="flex items-center gap-1">
          <button
            ...
            className="grid size-11 place-items-center rounded-xl text-body hover:bg-slate-100 hover:text-teal-800"
          >
        ...
        <div className="flex items-center gap-2">
          <span className="max-w-[26vw] truncate text-xs font-semibold text-body">
            {user.name.split(" ")[0]}
          </span>
          <button
            type="button"
