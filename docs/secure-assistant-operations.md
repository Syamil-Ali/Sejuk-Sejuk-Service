...
3. Install and run Agno: `cd backend/agno`, `py -m pip install -r requirements.lock`, then `py -m uvicorn sejuk_assistant.main:app --reload --port 8000`.
