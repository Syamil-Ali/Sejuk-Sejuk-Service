-- Field technicians can ingest receipts and save receipt extractions for
-- documents they uploaded themselves. Order-form extraction remains limited to
...
begin
  if public.current_role() not in ('admin', 'manager', 'technician') then
    raise exception 'Admin, manager or technician access required';
  end if;
